...
def trainval(exp_dict, savedir, args):
    ...
    config.snapshot_base_dir = f"/mnt/public/projects/{args.user}/{args.project_name}/pretrained_models/{exp_dict['agent']}/{exp_dict['env']}/{exp_dict['task']}/{exp_dict['seed']}"
...
if __name__ == "__main__":
    ...
    hw.run_wizard(
        func=trainval,
        exp_list=exp_configs.EXP_GROUPS[args.project_name+"_finetune"],
