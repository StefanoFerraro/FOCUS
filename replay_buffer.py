...
class ReplayBuffer(IterableDataset):
    def __init__(
        ...
        self._complete_eps = load_episodes(
            self._directory, capacity, minlen, load_first=load_first
        )
        ...
        try:
            ...
            print(
                "Incosistency between min/max/length in the replay buffer. Defaulting to (length): ",
                length,
            )
    ...
    def __iter__(self):
        ...
        while True:
            ...
            chunk = {
                k: torch.as_tensor(np.copy(v), device=self.device)
