projects = {
    "dmc" : ["ferrarostefano", "offline_lexa_dmc", "explore"],     
}
...
target_metrics = ['move_to_target_min', 'move_to_target_max', 'move_to_target_mean', 'move_to_target_final', 'episode_reward', 'success']

expl_metrics_keys = [ 'eval/' + k for k in target_metrics]

config_keys = ['task', 'comment', 'seed']
    
all_keys = ['agent'] + config_keys + expl_metrics_keys # 1 for agent and 1 for eval_reward
