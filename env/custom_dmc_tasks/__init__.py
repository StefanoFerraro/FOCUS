from env.custom_dmc_tasks import cheetah
from env.custom_dmc_tasks import walker
from env.custom_dmc_tasks import hopper
from env.custom_dmc_tasks import quadruped
from env.custom_dmc_tasks import jaco
